        ...
        return (
            <div className="about" id={REFS[routeNames.ABOUT]}>
                <SideHead heading={'About Us'}>
                    <ReactWoW animation='aboutContent'>
                        <p className='aboutContent'>
                            Quari English Public School was established in year 2019 is an Institution which provides quality all around education to all young boys
